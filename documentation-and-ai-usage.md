...
To rapidly prototype and deploy this architecture, the initial Kubernetes and Strimzi YAML manifests were generated using [Gemini](https://gemini.google.com) to speed up boilerplate scaffolding. However, to ensure production readiness, security, and architectural integrity, all generated configurations were strictly validated against the official Kubernetes and [Strimzi documentation](https://strimzi.io/documentation/).
