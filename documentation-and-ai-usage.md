...
To rapidly prototype and deploy this architecture, the initial Kubernetes and Strimzi YAML manifests were generated using [Gemini](https://gemini.google.com) to speed up boilerplate scripts. 
...
Gemini was also utilized as a pair-programming assistant to debug and resolve several complex infrastructure hurdles during the integration of the Kafka Connect plugins builds. 
